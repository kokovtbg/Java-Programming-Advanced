...
public class TireRawData {
    ...
    public TireRawData(String model, double tire1Pressure, int tire1Age, double tire2Pressure, int tire2Age, double tire3Pressure, int tire3Age, double tire4Pressure, int tire4Age) {
        this.model = model;
